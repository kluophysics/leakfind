C*==rmatstruct.f    processed by SPAG 6.70Rc at 15:38 on 19 Dec 2016
      SUBROUTINE RMATSTRUCT(STR,A,N,M,MLIN,MCOL,NQ,TOLP,K_OUTPUT)
C   ********************************************************************
C   *                                                                  *
...
99003 FORMAT (/,8X,'symbols used:',/,(8X,I3,3X,A1,2X,F20.12))
