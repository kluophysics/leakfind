C*==rdiffer.f    processed by SPAG 6.70Rc at 15:38 on 19 Dec 2016
      SUBROUTINE RDIFFER(IM,F,FP)
C   *******************************************************************
C   *                                                                 *
C   *   differentiate REAL function F(r)                              *
C   *                                                                 *
...
C
      ...
      PARAMETER (ROUTINE='RDIFFER')
C
C Dummy arguments
C
      INTEGER IM
      REAL*8 F(NRMAX),FP(NRMAX)
C
C Local variables
C
