C*==rradint_inw_r.f    processed by SPAG 6.70Rc at 15:38 on 19 Dec 2016
      SUBROUTINE RRADINT_INW_R(IM,F,FINT)
C   ********************************************************************
C   *                                                                  *
...
C
      ...
      PARAMETER (ROUTINE='RRADINT_INW_R')
      REAL*8 R12,R3
...
C Local variables
C
      REAL*8 FINTREF,FIP1_2,FIP1_4,FIP2_2,FIP2_5,FI_2,FI_5
