C*==rradint.f    processed by SPAG 6.70Rc at 15:38 on 19 Dec 2016
      SUBROUTINE RRADINT(IM,F,FINT)
C   ********************************************************************
C   *                                                                  *
C   * integrates a  REAL   FUNCTION F(i) tabulated on the mesh  IM     *
...
C
      END
C*==rradint_r.f    processed by SPAG 6.70Rc at 15:38 on 19 Dec 2016
      SUBROUTINE RRADINT_R(IM,F,FINT)
C   ********************************************************************
C   *                                                                  *
C   * integrates a  REAL   FUNCTION F(i) tabulated on the mesh  IM     *
C   * OUTWARDS  using the 3 point Simpson method                       *
...
C
      INTEGER IM
      REAL*8 F(NRMAX),FINT(NRMAX)
C
C Local variables
C
      REAL*8 FINTREF,FIP1_2,FIP1_4,FI_2,FI_5
