C*==chiintabr3.f    processed by SPAG 6.70Rc at 15:35 on 19 Dec 2016
      SUBROUTINE CHIINTABR3(CIAB,AG,BG,WGTG,AGBG,AMEG,AF,BF,WGTF,AFBF,
...
C KKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK
      DO K1 = 1,NSOL
         DO K2 = 1,NSOL
C
            CALL CHIINTABR2(AG(1,1,K1),BG(1,1,K2),AGBG,AF(1,1,K1),
