C*==chiintgabr3.f    processed by SPAG 6.70Rc at 15:35 on 19 Dec 2016
      SUBROUTINE CHIINTGABR3(CIAB,AG,BG,WGTG,AGBG,AMEG,AF,BF,WGTF,AFBF,
     &                       AMEF,WGTR,NSOL,JTOP,NRMAX)
C   ********************************************************************
C   *                                                                  *
C   *      SET UP INTEGRAND    FROM 0 TO R_I OF PRODUCT OF             *
C   *        REGULAR/IRREGULAR SOLUTIONS OF DIRAC EQUATION             *
C   *        (E.G. Z(A)Z(B), Z(A)J(B), J(A)Z(B) UND J(A)J(B))          *
C   *        BY CALCULATING THE INTEGRAND G*G AND F*F                  *
...
C KKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK
      DO K1 = 1,NSOL
         DO K2 = 1,NSOL
C
            CALL CHIINTGABR2(AG(1,1,K1),BG(1,1,K2),AGBG,AF(1,1,K1),
